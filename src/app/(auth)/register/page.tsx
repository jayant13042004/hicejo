    ...
    <div className="flex min-h-screen w-screen items-center justify-center bg-background px-4">
      ...
      <Card className="w-full max-w-md border-border/50">
        <CardHeader className="space-y-2 text-center">
          ...
          <CardDescription>
            Join Hicejo to optimize your career search funnel
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {success && (
              <div className="rounded-lg bg-emerald-500/15 p-3 text-sm text-emerald-500 font-medium border border-emerald-500/20">
            ...
            <Input
              ...
              disabled={success}
            />
            <Button type="submit" className="w-full bg-gradient-to-r from-primary to-violet-600" isLoading={isLoading} disabled={success}>
              Create Account
            </Button>

            <div className="relative flex items-center justify-center my-2">
              <span className="absolute w-full h-px bg-border/80" />
              <span className="relative px-3 text-[10px] text-muted-foreground uppercase bg-card font-bold">
                Or Continue With
              </span>
            </div>
            ...
            <div className="relative flex items-center justify-center my-4">
              <span className="absolute w-full h-px bg-border/80" />
              <span className="relative px-3 text-xs text-muted-foreground uppercase bg-card font-semibold animate-pulse">
                Sandbox Mode
              </span>
            </div>
            <Button
              type="button"
              variant="outline"
              className="w-full border-dashed hover:border-primary/45 hover:bg-primary/5 gap-2"
              onClick={() => {
